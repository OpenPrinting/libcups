...
"\"\\\"%s\\\": Bad mimeMediaType value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.10).\" = \"\\\"%s\\\": Неверное значение \\\"%s\\\" mimeMediaType — %d неверная длина (RFC 8011, раздел 5.1.10).\";\n"
...
"\"%s: Missing filename after '-L'.\" = \"%s: Отсутствующее имя файла после '-L'.\";\n"
...
"\"-L LOGFILE                     Set log file (start with '+' to append)\" = \"-L LOGFILE                     Задать файл журнала (для добавления начинайте с '+')\";\n"
...
"\"binding\" = \"Сшить вывод\";\n"
"\"binding-reference-edge\" = \"Сшить край\";\n"
"\"binding-reference-edge.bottom\" = \"Низ\";\n"
"\"binding-reference-edge.left\" = \"Слева\";\n"
...
"\"coating-sides\" = \"Добавить покрытие к\";\n"
"\"coating-sides.back\" = \"Оборот\";\n"
"\"coating-sides.both\" = \"Front and back\";\n"
"\"coating-sides.front\" = \"Лицевая сторона\";\n"
"\"coating-type\" = \"Тип покрытия\";\n"
"\"coating-type.archival\" = \"Архивный\";\n"
...
"\"coating-type.glossy\" = \"Глянцевый\";\n"
"\"coating-type.high-gloss\" = \"High gloss\";\n"
"\"coating-type.matte\" = \"Матовый\";\n"
"\"coating-type.semi-gloss\" = \"Полуглянцевый\";\n"
"\"coating-type.silicone\" = \"Силикон\";\n"
"\"coating-type.translucent\" = \"Полупрозрачный\";\n"
"\"coating-type.water-resistant\" = \"Водостойкость\";\n"
"\"completed\" = \"завершено\";\n"
"\"confirmation-sheet-print\" = \"Распечатать подтверждающий лист\";\n"
"\"copies\" = \"Number of Copies\";\n"
"\"copies=N                       Set number of copies\" = \"копий=N                       Заданное количество копий\";\n"
"\"cover-type\" = \"Печатная обложка\";\n"
