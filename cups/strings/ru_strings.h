...
"\"%s: Bad version %s for \\\"-V\\\".\" = \"%s: Неверная версия %s для \\\"-V\\\".\";\n"
"\"%s: Missing filename for \\\"-P\\\".\" = \"%s: Пропущено имя файла для \\\"-P\\\".\";\n"
"\"%s: Missing timeout for \\\"-T\\\".\" = \"%s: Пропущен таймаут для \\\"-T\\\".\";\n"
"\"%s: Missing version for \\\"-V\\\".\" = \"%s: Пропущена версия для \\\"-V\\\".\";\n"
"\"%s: Unable to open \\\"%s\\\": %s\" = \"%s: Не удается открыть \\\"%s\\\": %s\";\n"
"\"%s: Unknown option \\\"%s\\\".\" = \"%s: Неизвестный параметр \\\"%s\\\".\";\n"
"\"%s: Unknown option \\\"-%c\\\".\" = \"%s: Неизвестный параметр \\\"-%c\\\".\";\n"
...
"\"ippfind: Bad regular expression: %s\" = \"ippfind: неправильное регулярное выражение: %s\";\n"
"\"ippfind: Cannot use --and after --or.\" = \"ippfind: не используйте --and после --or.\";\n"
"\"ippfind: Expected key name after %s.\" = \"ippfind: Ожидается key name после %s.\";\n"
"\"ippfind: Expected port range after %s.\" = \"ippfind: Ожидается port range после %s.\";\n"
"\"ippfind: Expected program after %s.\" = \"ippfind: Ожидается program после %s.\";\n"
"\"ippfind: Expected semi-colon after %s.\" = \"ippfind: Ожидается semi-colon после %s.\";\n"
"\"ippfind: Missing close brace in substitution.\" = \"ippfind: Отсутствует закрывающая фигурная скобка в замене.\";\n"
"\"ippfind: Missing close parenthesis.\" = \"ippfind: Отсутствует закрывающая скобка.\";\n"
"\"ippfind: Missing expression before \\\"--and\\\".\" = \"ippfind: Отсутствует выражение перед \\\"--and\\\".\";\n"
"\"ippfind: Missing expression before \\\"--or\\\".\" = \"ippfind: Отсутствует выражение перед \\\"--or\\\".\";\n"
"\"ippfind: Missing key name after %s.\" = \"ippfind: Отсутствует key name после %s.\";\n"
"\"ippfind: Missing name after %s.\" = \"ippfind: Missing name after %s.\";\n"
"\"ippfind: Missing open parenthesis.\" = \"ippfind: Отсутствует открывающая скобка.\";\n"
"\"ippfind: Missing program after %s.\" = \"ippfind: Отсутствует program после %s.\";\n"
"\"ippfind: Missing regular expression after \" = \"ippfind: Missing regular expression after \";\n"
"\"ippfind: Missing regular expression after %s.\" = \"ippfind: Отсутствует регулярное выражение после %s.\";\n"
"\"ippfind: Missing semi-colon after %s.\" = \"ippfind: Отсутствует semi-colon после %s.\";\n"
"\"ippfind: Out of memory.\" = \"ippfind: Недостаточно памяти.\";\n"
"\"ippfind: Too many parenthesis.\" = \"ippfind: Слишком много скобок.\";\n"
"\"ippfind: Unable to execute \\\"%s\\\": %s\" = \"ippfind: Не удается выполнить \\\"%s\\\": %s\";\n"
"\"ippfind: Unknown variable \\\"{%s}\\\".\" = \"ippfind: Неизвестная переменная \\\"{%s}\\\".\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\" = \"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"-P\\\" and \\\"-X\\\".\" = \"ipptool: Параметры \\\"-i\\\" и \\\"-n\\\" несовместимы с \\\"-P\\\" и \\\"-X\\\".\";\n"
"\"ipptool: Bad URI \\\"%s\\\".\" = \"ipptool: Bad URI \\\"%s\\\".\";\n"
"\"ipptool: Invalid seconds for \\\"-i\\\".\" = \"ipptool: Неправильные секунды для \\\"-i\\\".\";\n"
"\"ipptool: May only specify a single URI.\" = \"ipptool: Может быть определен лишь один URI.\";\n"
"\"ipptool: Missing count for \\\"-n\\\".\" = \"ipptool: Отсутствует count для \\\"-n\\\".\";\n"
...
"\"ipptool: Missing name=value for \\\"-d\\\".\" = \"ipptool: Отсутствует name=value для \\\"-d\\\".\";\n"
"\"ipptool: Missing seconds for \\\"-i\\\".\" = \"ipptool: Отсутствуют секунды для \\\"-i\\\".\";\n"
