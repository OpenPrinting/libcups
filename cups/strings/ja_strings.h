...
"\"%s: Bad version %s for \\\"-V\\\".\" = \"%s: -V オプションにおいて %s は不正なバージョンです。\";\n"
"\"%s: Missing filename for \\\"-P\\\".\" = \"%s: \\\"-P\\\" にファイル名がありません。\";\n"
"\"%s: Missing timeout for \\\"-T\\\".\" = \"%s: \\\"-T\\\" オプションにタイムアウトが設定されていません。\";\n"
"\"%s: Missing version for \\\"-V\\\".\" = \"%s: \\\"-V\\\" オプションにバージョンの指定がありません。\";\n"
"\"%s: Unable to open \\\"%s\\\": %s\" = \"%s: \\\"%s\\\" を開けません: %s\";\n"
"\"%s: Unknown option \\\"%s\\\".\" = \"%s: \\\"%s\\\" は未知のオプションです。\";\n"
"\"%s: Unknown option \\\"-%c\\\".\" = \"%s: \\\"-%c\\\" は未知のオプションです。\";\n"
...
"\"Usage: ipptool [options] URI filename [ ... filenameN ]\" = \"使い方: ipptool [オプション] URI ファイル名 [ ... ファイル名N ]\";\n"
"\"Use Proxy\" = \"Use Proxy\";\n"
...
"\"ippfind: Bad regular expression: %s\" = \"ippfind: 不正な正規表現です: %s\";\n"
"\"ippfind: Cannot use --and after --or.\" = \"ippfind: --and は --or のあとに指定することはできません。\";\n"
"\"ippfind: Expected key name after %s.\" = \"ippfind: %s のあとにはキー名が必要です。\";\n"
"\"ippfind: Expected port range after %s.\" = \"ippfind: %s のあとにはポート範囲が必要です。\";\n"
"\"ippfind: Expected program after %s.\" = \"ippfind: %s のあとにはプログラム名が必要です。\";\n"
"\"ippfind: Expected semi-colon after %s.\" = \"ippfind: %s のあとにはセミコロンが必要です。\";\n"
"\"ippfind: Missing close brace in substitution.\" = \"ippfind: 置換文字列の閉じカッコがありません。\";\n"
"\"ippfind: Missing close parenthesis.\" = \"ippfind: 閉じカッコが不足しています。\";\n"
"\"ippfind: Missing expression before \\\"--and\\\".\" = \"ippfind: \\\"--and\\\" の前には式が必要です。\";\n"
"\"ippfind: Missing expression before \\\"--or\\\".\" = \"ippfind: \\\"--or\\\" の前には式が必要です。\";\n"
"\"ippfind: Missing key name after %s.\" = \"ippfind: %s のあとにはキー名が必要です。\";\n"
"\"ippfind: Missing name after %s.\" = \"ippfind: Missing name after %s.\";\n"
"\"ippfind: Missing open parenthesis.\" = \"ippfind: 開きカッコが足りません。\";\n"
"\"ippfind: Missing program after %s.\" = \"ippfind: %s のあとにはプログラム名が必要です。\";\n"
"\"ippfind: Missing regular expression after \" = \"ippfind: Missing regular expression after \";\n"
"\"ippfind: Missing regular expression after %s.\" = \"ippfind: %s のあとには正規表現が必要です。\";\n"
"\"ippfind: Missing semi-colon after %s.\" = \"ippfind: %s のあとにはセミコロンが必要です。\";\n"
"\"ippfind: Out of memory.\" = \"ippfind: メモリ不足です。\";\n"
"\"ippfind: Too many parenthesis.\" = \"ippfind: カッコが多すぎます。\";\n"
"\"ippfind: Unable to execute \\\"%s\\\": %s\" = \"ippfind: \\\"%s\\\" を実行できません: %s\";\n"
"\"ippfind: Unknown variable \\\"{%s}\\\".\" = \"ippfind: \\\"{%s}\\\" は不明な変数です。\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\" = \"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"-P\\\" and \\\"-X\\\".\" = \"ipptool: \\\"-i\\\" および \\\"-n\\\" は \\\"-P\\\"、\\\"-X\\\" と一緒に指定できません。\";\n"
"\"ipptool: Bad URI \\\"%s\\\".\" = \"ipptool: Bad URI \\\"%s\\\".\";\n"
"\"ipptool: Invalid seconds for \\\"-i\\\".\" = \"ipptool: \\\"-i\\\" に不正な秒数が指定されました。\";\n"
"\"ipptool: May only specify a single URI.\" = \"ipptool: URI は 1 つだけ指定できます。\";\n"
"\"ipptool: Missing count for \\\"-n\\\".\" = \"ipptool: \\\"-n\\\" に回数の指定がありません。\";\n"
...
"\"ipptool: Missing name=value for \\\"-d\\\".\" = \"ipptool: \\\"-d\\\" に 名前=値 の指定がありません。\";\n"
"\"ipptool: Missing seconds for \\\"-i\\\".\" = \"ipptool: \\\"-i\\\" に秒数の指定がありません。\";\n"
