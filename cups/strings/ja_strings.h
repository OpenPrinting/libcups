...
"\"%s (%s, %s)\" = \"%s (%s, %s)\";\n"
"\"%s (Borderless)\" = \"%s (ふちなし)\";\n"
"\"%s (Borderless, %s)\" = \"%s (ふちなし, %s)\";\n"
"\"%s (Borderless, %s, %s)\" = \"%s (ふちなし, %s, %s)\";\n"
"\"%s: %s\" = \"%s: %s\";\n"
...
"\"Bad NULL dests pointer\" = \"不正な NULL 送信先ポインター\";\n"
"\"Bad Request\" = \"不正なリクエスト\";\n"
"\"Bad URI.\" = \"Bad URI.\";\n"
"\"Bad arguments to function\" = \"関数の引数が不正\";\n"
...
"\"Encryption is not supported.\" = \"暗号化はサポートされていません。\";\n"
"\"Environment Variables:\" = \"環境変数:\";\n"
"\"Errors:\\n\" = \"Errors:\\n\";\n"
"\"Expectation Failed\" = \"予測に失敗しました\";\n"
"\"Expressions:\" = \"式:\";\n"
...
"\"IPP attribute has no name.\" = \"IPP の属性に名前がありません。\";\n"
"\"IPP attribute is not a member of the message.\" = \"IPP の属性がメッセージのメンバーではありません。\";\n"
"\"IPP begCollection value not 0 bytes.\" = \"IPP の begCollection は想定された 0 バイトになっていません。\";\n"
"\"IPP boolean value not 1 byte.\" = \"IPP の真偽値が想定された 1 バイトになっていません。\";\n"
"\"IPP date value not 11 bytes.\" = \"IPP の date 値は想定された 11 バイトになっていません。\";\n"
"\"IPP endCollection value not 0 bytes.\" = \"IPP の endCollection は想定された 0 バイトになっていません。\";\n"
"\"IPP enum value not 4 bytes.\" = \"IPP の enum 値は想定された 4 バイトになっていません。\";\n"
"\"IPP integer value not 4 bytes.\" = \"IPP の整数値は想定された 4 バイトになっていません。\";\n"
"\"IPP language length overflows value.\" = \"IPP の language length の値がオーバーフローしています。\";\n"
"\"IPP language length too large.\" = \"IPP の language の長さが長すぎます。\";\n"
"\"IPP member attribute outside of collection.\" = \"IPP member attribute outside of collection.\";\n"
"\"IPP member name is not empty.\" = \"IPP のメンバー名が空ではありません。\";\n"
"\"IPP memberName value is empty.\" = \"IPP の memberName の値が空です。\";\n"
"\"IPP message nested too deeply.\" = \"IPP message nested too deeply.\";\n"
"\"IPP name larger than 32767 bytes.\" = \"IPP 名が 32767 バイトより大きいです。\";\n"
"\"IPP nameWithLanguage value less than minimum 4 bytes.\" = \"IPP nameWithLanguage value less than minimum 4 bytes.\";\n"
"\"IPP octetString length too large.\" = \"IPP の octetString の長さが大きすぎます。\";\n"
"\"IPP rangeOfInteger value not 8 bytes.\" = \"IPP の rangeOfInteger は想定された 8 バイトになっていません。\";\n"
"\"IPP resolution value not 9 bytes.\" = \"IPP の resolution は想定された 9 バイトになっていません。\";\n"
"\"IPP string length overflows value.\" = \"IPP の文字列長の値がオーバーフローしています。\";\n"
"\"IPP textWithLanguage value less than minimum 4 bytes.\" = \"IPP textWithLanguage value less than minimum 4 bytes.\";\n"
"\"IPP value larger than 32767 bytes.\" = \"IPP の値が 32767 バイト以上です。\";\n"
...
"\"Invalid media name arguments.\" = \"無効なメディア名引数です。\";\n"
"\"Invalid media size.\" = \"無効なメディアサイズです。\";\n"
...
"\"Missing media or media-col.\" = \"media または media-col がありません。\";\n"
"\"Missing media-size in media-col.\" = \"media-col に media-size がありません。\";\n"
"\"Missing resource in URI\" = \"URI のリソースがない\";\n"
"\"Missing scheme in URI\" = \"URI のスキームがない\";\n"
"\"Missing x-dimension in media-size.\" = \"media-size に x-dimension がありません。\";\n"
"\"Missing y-dimension in media-size.\" = \"media-size に y-dimension がありません。\";\n"
"\"Modifiers:\" = \"修飾子:\";\n"
"\"Moved Permanently\" = \"別の場所へ移動しました\";\n"
...
"\"No active connection\" = \"アクティブな接続はありません\";\n"
"\"No active connection.\" = \"アクティブな接続はありません。\";\n"
"\"No default destination.\" = \"No default destination.\";\n"
"\"No request URI.\" = \"リクエスト URI がありません。\";\n"
"\"No request protocol version.\" = \"リクエストプロトコルバージョンがありません。\";\n"
"\"No request sent.\" = \"リクエストが送られませんでした。\";\n"
...
"\"Password for %s on %s? \" = \"%s のパスワード (%s 上)? \";\n"
...
"\"Server credentials not set.\" = \"サーバー証明書が設定されていません。\";\n"
"\"Service Unavailable\" = \"利用できないサービス\";\n"
"\"Sheet Backs:\" = \"Sheet Backs:\";\n"
"\"Sub-Commands:\" = \"Sub-Commands:\";\n"
"\"Substitutions:\" = \"置換:\";\n"
"\"Switching Protocols\" = \"プロトコルの変更\";\n"
...
"\"The printer or class does not exist.\" = \"プリンターまたはクラスは存在しません。\";\n"
"\"Title:\" = \"Title:\";\n"
"\"Too Early\" = \"Too Early\";\n"
...
"\"URI too large\" = \"URI が長すぎる\";\n"
"\"Unable to add extension to X.509 certificate.\" = \"Unable to add extension to X.509 certificate.\";\n"
"\"Unable to compile mimeMediaType regular expression: %s.\" = \"mimeMediaType の正規表現を解釈できませんでした: %s。\";\n"
"\"Unable to compile naturalLanguage regular expression: %s.\" = \"naturalLanguage の正規表現を解釈できませんでした: %s。\";\n"
"\"Unable to configure private key context.\" = \"Unable to configure private key context.\";\n"
"\"Unable to connect to host.\" = \"ホストに接続できません。\";\n"
...
"\"Unable to create printer-uri\" = \"printer-uri を作成できません\";\n"
...
"\"Unable to create server credentials.\" = \"サーバー証明書を作成できません。\";\n"
...
"\"Unable to resolve printer-uri.\" = \"printer-uri を解決できません。\";\n"
...
"\"Unknown media size name.\" = \"未知のメディアサイズ名称です。\";\n"
"\"Unknown request method.\" = \"未知のリクエスト方法です。\";\n"
"\"Unknown request version.\" = \"未知のリクエストバージョンです。\";\n"
"\"Unknown scheme in URI\" = \"URI に未知のスキーマがあります\";\n"
"\"Unknown service name.\" = \"未知のサービス名です。\";\n"
"\"Unprocessable Content\" = \"Unprocessable Content\";\n"
"\"Unsupported Media Type\" = \"Unsupported Media Type\";\n"
"\"Unsupported media value.\" = \"サポートされていないメディアの値です。\";\n"
...
"\"ipptool: May only specify a single URI.\" = \"ipptool: URI は 1 つだけ指定できます。\";\n"
"\"ipptool: Missing filename for \\\"-f\\\".\" = \"ipptool: \\\"-f\\\" にファイル名の指定がありません。\";\n"
"\"ipptool: URI required before test file.\" = \"ipptool: テストファイルの前に URI の指定が必要です。\";\n"
