...
"\"%s: Bad regular expression: %s\" = \"%s: Nesprávný regulární výraz: %s\";\n"
"\"%s: Bad resolution value '%s'.\" = \"%s: Nesprávná hodnota rozlišení „%s“.\";\n"
...
"\"%s: Invalid device URI '%s'.\" = \"%s: Neplatný URI identifikátor zařízení „%s“.\";\n"
"\"%s: Invalid seconds \\\"%s\\\" for '-i'.\" = \"%s: Invalid seconds \\\"%s\\\" for '-i'.\";\n"
"\"%s: Invalid speed(s) value \\\"%s\\\".\" = \"%s: Neplatná hodnota rychlosti/í „%s“.\";\n"
...
"\"%s: Missing command after '-c'.\" = \"%s: Chybí příkaz za „-c“.\";\n"
"\"%s: Missing count after '-n'.\" = \"%s: Chybí počet za „-n“.\";\n"
...
"\"Accepted\" = \"Přijatý\";\n"
"\"Already Reported\" = \"Už nahlášeno\";\n"
"\"Bad Gateway\" = \"Nesprávná brána\";\n"
"\"Bad NULL dests pointer\" = \"Neplatný ukazatel NULL\";\n"
"\"Bad Request\" = \"Chybný požadavek\";\n"
"\"Bad URI.\" = \"Nesprávné URI.\";\n"
"\"Bad arguments to function\" = \"Bad arguments to function\";\n"
"\"Bad certificate.\" = \"Nesprávný certifikát.\";\n"
...
"\"Bad printer-uri.\" = \"Nesprávné printer-uri.\";\n"
...
"\"Bad/empty URI\" = \"Nesprávné/nevyplněné URI\";\n"
"\"Conflict\" = \"Conflict\";\n"
...
"\"Device URIs:\" = \"URI identifikátory zařízení:\";\n"
...
"\"Errors:\\n\" = \"Errors:\\n\";\n"
"\"Expectation Failed\" = \"Očekávané údaje jsou neplatné\";\n"
...
"\"Input Formats:\" = \"Vstupní formáty:\";\n"
"\"Insufficient Storage\" = \"Nedostatečné úložiště\";\n"
...
"\"Modifiers:\" = \"Modifiers:\";\n"
"\"Moved Permanently\" = \"Trvale přesunuto\";\n"
"\"Multi-Status\" = \"Multi-Status\";\n"
"\"Multiple Choices\" = \"Vícero možností\";\n"
...
"\"No active connection\" = \"Není aktivní spojení\";\n"
...
"\"Not Authoritative\" = \"Neautoritativní\";\n"
"\"Not Found\" = \"Nebyl nalezen\";\n"
"\"Not Implemented\" = \"Nerealizováno\";\n"
...
"\"Password for %s on %s? \" = \"Heslo pro %s na %s? \";\n"
"\"Payment Required\" = \"Vyžadována platba\";\n"
"\"Permanent Redirect\" = \"Trvalé přesměrování\";\n"
"\"Precondition Failed\" = \"Precondition Failed\";\n"
"\"Precondition Required\" = \"Precondition Required\";\n"
"\"Print Job:\" = \"Tisk úlohy:\";\n"
"\"Printer:\" = \"Tiskárna:\";\n"
...
"\"Sub-Commands:\" = \"Dílčí příkazy:\";\n"
"\"Substitutions:\" = \"Substitutions:\";\n"
"\"Switching Protocols\" = \"Protokol výměny\";\n"
...
"\"Unable to connect to host.\" = \"Nelze se připojit k hostiteli.\";\n"
...
"\"Unprocessable Content\" = \"Nezpracovatelný obsah\";\n"
"\"Unsupported Media Type\" = \"Unsupported Media Type\";\n"
"\"Unsupported media value.\" = \"Unsupported media value.\";\n"
"\"Upgrade Required\" = \"Povinné aktualizace\";\n"
...
"\"binding-type.flat\" = \"Ploché\";\n"
"\"binding-type.padding\" = \"Zarovnávání\";\n"
"\"binding-type.perfect\" = \"Perfektní\";\n"
"\"binding-type.spiral\" = \"Spiral\";\n"
"\"binding-type.tape\" = \"Páska\";\n"
...
"\"coating-type.archival\" = \"Archivní\";\n"
...
"\"coating-type.glossy\" = \"Lesklé\";\n"
"\"coating-type.high-gloss\" = \"High gloss\";\n"
"\"coating-type.matte\" = \"Matný\";\n"
"\"coating-type.semi-gloss\" = \"Pololesklý\";\n"
"\"coating-type.silicone\" = \"Silicone\";\n"
"\"coating-type.translucent\" = \"Průhledný\";\n"
"\"coating-type.water-resistant\" = \"Voděodolné\";\n"
"\"completed\" = \"dokončeno\";\n"
...
"\"covering-name.pre-printed\" = \"Předtištěný\";\n"
...
"\"document-state.3\" = \"Čekající\";\n"
"\"document-state.5\" = \"Processing\";\n"
"\"document-state.6\" = \"Zastaveno\";\n"
"\"document-state.7\" = \"Zrušeno\";\n"
"\"document-state.8\" = \"Přerušeno\";\n"
"\"document-state.9\" = \"Dokončeno\";\n"
"\"finishing-template.bale\" = \"Bale\";\n"
"\"finishing-template.bind\" = \"Sešít\";\n"
...
"\"finishing-template.coat\" = \"Potáhnout\";\n"
"\"finishing-template.cover\" = \"Zakrýt\";\n"
...
"\"finishing-template.fold\" = \"Přeložit\";\n"
...
"\"finishing-template.laminate\" = \"Zalaminovat\";\n"
"\"finishing-template.punch\" = \"Proděrovat\";\n"
...
"\"finishing-template.staple\" = \"Razítko\";\n"
...
"\"imposition-template.position_left_middle\" = \"Vlevo uprostřed\";\n"
"\"imposition-template.position_left_top\" = \"Vlevo nahoře\";\n"
"\"imposition-template.position_right_bottom\" = \"Vpravo dole\";\n"
"\"imposition-template.position_right_middle\" = \"Vpravo uprostřed\";\n"
...
"\"imposition-template.tile\" = \"Dlaždice\";\n"
...
"\"input-sides\" = \"Oboustranné skenování\";\n"
...
"\"job-delay-output-until.day-time\" = \"Denní doba\";\n"
"\"job-delay-output-until.evening\" = \"Dopoledne\";\n"
"\"job-delay-output-until.indefinite\" = \"Released\";\n"
"\"job-delay-output-until.night\" = \"Noc\";\n"
...
"\"job-delay-output-until.weekend\" = \"Víkend\";\n"
...
"\"job-error-sheet-when.always\" = \"Vždy\";\n"
...
"\"job-state-reasons.compression-error\" = \"Chyba dekomprese\";\n"
...
"\"job-state-reasons.errors-detected\" = \"Zjištěny chyby\";\n"
...
"\"job-state-reasons.warnings-detected\" = \"Zjištěna varování\";\n"
"\"job-state.3\" = \"Čekající\";\n"
"\"job-state.4\" = \"Held\";\n"
"\"job-state.5\" = \"Processing\";\n"
"\"job-state.6\" = \"Zastaveno\";\n"
"\"job-state.7\" = \"Zrušeno\";\n"
"\"job-state.8\" = \"Přerušeno\";\n"
"\"job-state.9\" = \"Dokončeno\";\n"
"\"label-mode-configured.applicator\" = \"Applicator\";\n"
"\"label-mode-configured.cutter\" = \"Řezačka\";\n"
"\"label-mode-configured.cutter-delayed\" = \"Řezačka pozdržena\";\n"
"\"label-mode-configured.kiosk\" = \"Kiosk\";\n"
"\"label-mode-configured.peel-off\" = \"Odškrábnout\";\n"
"\"label-mode-configured.peel-off-prepeel\" = \"Peel off prepeel\";\n"
"\"label-mode-configured.rewind\" = \"Převinout\";\n"
"\"label-mode-configured.rfid\" = \"Rfid\";\n"
"\"label-mode-configured.tear-off\" = \"Odtrhnout\";\n"
"\"laminating\" = \"Laminovat stránky\";\n"
"\"laminating-sides\" = \"Zalaminovat\";\n"
...
"\"laminating-type.archival\" = \"Archivní\";\n"
"\"laminating-type.archival-glossy\" = \"Archivní lesklý\";\n"
"\"laminating-type.archival-matte\" = \"Archivní matný\";\n"
"\"laminating-type.archival-semi-gloss\" = \"Archival semi gloss\";\n"
"\"laminating-type.glossy\" = \"Lesklé\";\n"
"\"laminating-type.high-gloss\" = \"High gloss\";\n"
"\"laminating-type.matte\" = \"Matný\";\n"
"\"laminating-type.semi-gloss\" = \"Pololesklý\";\n"
"\"laminating-type.translucent\" = \"Průhledný\";\n"
"\"laminating-type.water-resistant\" = \"Voděodolný\";\n"
...
"\"media-color.gray\" = \"Šedý\";\n"
"\"media-color.green\" = \"Green\";\n"
"\"media-color.ivory\" = \"Slonovinový\";\n"
...
"\"media-tracking\" = \"Sledování média\";\n"
"\"media-tracking.continuous\" = \"Kontinuální\";\n"
"\"media-tracking.gap\" = \"Mezera\";\n"
"\"media-tracking.mark\" = \"Mark\";\n"
"\"media-tracking.web\" = \"Web\";\n"
"\"media-type\" = \"Media Type\";\n"
"\"media-type.aluminum\" = \"Hliník\";\n"
...
"\"media-type.foil\" = \"Fólie\";\n"
"\"media-type.full-cut-tabs\" = \"Full cut tabs\";\n"
"\"media-type.glass\" = \"Sklo\";\n"
...
"\"media-type.transparency\" = \"Průhlednost\";\n"
...
"\"media.na_a2_4.375x5.75in\" = \"Obálka A2\";\n"
"\"media.na_c5_6.5x9.5in\" = \"Obálka C5\";\n"
...
"\"media.na_monarch_3.875x7.5in\" = \"Obálka Monarch\";\n"
"\"media.na_number-10_4.125x9.5in\" = \"Obálka č. 10\";\n"
"\"media.na_number-11_4.5x10.375in\" = \"Obálka č. 11\";\n"
"\"media.na_number-12_4.75x11in\" = \"Obálka č. 12\";\n"
"\"media.na_number-14_5x11.5in\" = \"Obálka č. 14\";\n"
"\"media.na_number-9_3.875x8.875in\" = \"Obálka č. 9\";\n"
"\"media.na_personal_3.625x6.5in\" = \"Obálka Personal\";\n"
...
"\"media.om_italian_110x230mm\" = \"Obálka Italian\";\n"
...
"\"media.om_postfix_114x229mm\" = \"Obálka Postfix\";\n"
...
"\"orientation-requested.4\" = \"Na šířku\";\n"
...
"\"print-scaling.fill\" = \"Vyplnit\";\n"
"\"print-scaling.fit\" = \"Přizpůsobit\";\n"
...
"\"printer-state-reasons.deactivated\" = \"Deaktivováno\";\n"
"\"printer-state-reasons.deleted\" = \"Smazáno\";\n"
...
"\"printer-state-reasons.marker-ink-empty\" = \"Inkoust prázdný\";\n"
...
"\"printer-state-reasons.paused\" = \"Pozastaveno\";\n"
...
"\"printer-state-reasons.stopping\" = \"Zastavování\";\n"
...
"\"printer-state-reasons.testing\" = \"Testování\";\n"
...
"\"printer-state-reasons.unknown\" = \"Neznámé\";\n"
...
"\"printer-state.3\" = \"Nečinné\";\n"
"\"printer-state.4\" = \"Processing\";\n"
"\"printer-state.5\" = \"Zastaveno\";\n"
...
"\"resource-state-reasons.cancel-requested\" = \"Zrušit\";\n"
"\"resource-state-reasons.install-requested\" = \"Install\";\n"
"\"resource-state-reasons.resource-incoming\" = \"Resource incoming\";\n"
"\"resource-state.3\" = \"Čeká\";\n"
"\"resource-state.4\" = \"K dispozici\";\n"
"\"resource-state.5\" = \"Nainstalované\";\n"
"\"resource-state.6\" = \"Zrušeno\";\n"
"\"resource-state.7\" = \"Přerušeno\";\n"
"\"resource-type.executable-firmware\" = \"Executable firmware\";\n"
"\"resource-type.executable-software\" = \"Executable software\";\n"
"\"resource-type.static-font\" = \"Statické písmo\";\n"
"\"resource-type.static-form\" = \"Statický formulář\";\n"
"\"resource-type.static-icc-profile\" = \"Static icc profile\";\n"
"\"resource-type.static-image\" = \"Statický obrázek\";\n"
"\"resource-type.static-logo\" = \"Statické logo\";\n"
"\"resource-type.static-other\" = \"Statické ostatní\";\n"
"\"resource-type.static-strings\" = \"Statické řetězce\";\n"
...
"\"retry-time-out\" = \"Časový limit opětovného pokusu\";\n"
...
"\"stitching\" = \"Razítko\";\n"
"\"stitching-method\" = \"Metoda razítkování\";\n"
"\"stitching-method.auto\" = \"Automatic\";\n"
"\"stitching-method.crimp\" = \"Crimp\";\n"
"\"stitching-method.wire\" = \"Drát\";\n"
...
"\"timeout-predicate.activity\" = \"Aktivita\";\n"
"\"timeout-predicate.inactivity\" = \"Neaktivita\";\n"
"\"timeout-predicate.none\" = \"None\";\n"
"\"transmission-status.3\" = \"Čeká\";\n"
"\"transmission-status.4\" = \"Pending retry\";\n"
"\"transmission-status.5\" = \"Processing\";\n"
"\"transmission-status.7\" = \"Zrušeno\";\n"
"\"transmission-status.8\" = \"Přerušeno\";\n"
"\"transmission-status.9\" = \"Dokončeno\";\n"
"\"trimming\" = \"Cut\";\n"
"\"trimming-offset\" = \"Pozice vyříznutí\";\n"
...
"\"trimming-when.after-job\" = \"Úloha\";\n"
"\"trimming-when.after-sets\" = \"Every set\";\n"
"\"trimming-when.after-sheets\" = \"Every page\";\n"
"\"unknown\" = \"neznámý\";\n"
"\"untitled\" = \"nepojmenovaný\";\n"
"\"which-printers.all\" = \"Vše\";\n"
"\"which-printers.idle\" = \"Nečinné\";\n"
"\"which-printers.not-accepting\" = \"Not accepting\";\n"
"\"which-printers.processing\" = \"Processing\";\n"
"\"which-printers.shutdown\" = \"Vypnout\";\n"
"\"which-printers.stopped\" = \"Zastaveno\";\n"
"\"which-printers.testing\" = \"Testuje se\";\n"
