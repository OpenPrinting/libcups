...
"\"%s: Bad version %s for \\\"-V\\\".\" = \"%s：用于“-V”的版本 %s 无效。\";\n"
"\"%s: Missing filename for \\\"-P\\\".\" = \"%s：“-P”选项缺少文件名。\";\n"
"\"%s: Missing timeout for \\\"-T\\\".\" = \"%s：“-T”选项缺少超时。\";\n"
"\"%s: Missing version for \\\"-V\\\".\" = \"%s：“-V”选项缺少版本。\";\n"
"\"%s: Unable to open \\\"%s\\\": %s\" = \"%s：无法打开“%s”：%s\";\n"
"\"%s: Unknown option \\\"%s\\\".\" = \"%s：未知选项“%s”。\";\n"
"\"%s: Unknown option \\\"-%c\\\".\" = \"%s：未知选项“-%c”。\";\n"
...
"\"No active connection.\" = \"无活动连接。\";\n"
"\"No common name specified.\" = \"未指定通用名称。\";\n"
...
"\"Unable to create credentials from array.\" = \"无法从打印组创建服务器凭据。\";\n"
...
"\"Usage: ipptool [options] URI filename [ ... filenameN ]\" = \"用法：ipptool [options] URI filename [ ... filenameN ]\";\n"
"\"Use Proxy\" = \"Use Proxy\";\n"
...
"\"ippfind: Bad regular expression: %s\" = \"ippfind：无效的正则表达式：%s\";\n"
"\"ippfind: Cannot use --and after --or.\" = \"ippfind：不能在 --or 后使用 --and。\";\n"
"\"ippfind: Expected key name after %s.\" = \"ippfind：在 %s 后预期键名。\";\n"
"\"ippfind: Expected port range after %s.\" = \"ippfind：在 %s 后预期端口范围。\";\n"
"\"ippfind: Expected program after %s.\" = \"ippfind：在 %s 后预期程序。\";\n"
"\"ippfind: Expected semi-colon after %s.\" = \"ippfind：在 %s 后预期分号。\";\n"
"\"ippfind: Missing close brace in substitution.\" = \"ippfind：替换操作后缺少右花括号。\";\n"
"\"ippfind: Missing close parenthesis.\" = \"ippfind：缺少右括号。\";\n"
"\"ippfind: Missing expression before \\\"--and\\\".\" = \"ippfind：“--and”前缺少表达式。\";\n"
"\"ippfind: Missing expression before \\\"--or\\\".\" = \"ippfind：“--or”前缺少表达式。\";\n"
"\"ippfind: Missing key name after %s.\" = \"ippfind：在 %s 后缺少键名。\";\n"
"\"ippfind: Missing name after %s.\" = \"ippfind：%s 后缺少名称。\";\n"
"\"ippfind: Missing open parenthesis.\" = \"ippfind：缺少左括号。\";\n"
"\"ippfind: Missing program after %s.\" = \"ippfind：在 %s 后缺少程序。\";\n"
"\"ippfind: Missing regular expression after \" = \"ippfind: Missing regular expression after \";\n"
"\"ippfind: Missing regular expression after %s.\" = \"ippfind：在 %s 后缺少正则表达式。\";\n"
"\"ippfind: Missing semi-colon after %s.\" = \"ippfind：在 %s 后缺少分号。\";\n"
"\"ippfind: Out of memory.\" = \"ippfind：内存不足。\";\n"
"\"ippfind: Too many parenthesis.\" = \"ippfind：括号过多。\";\n"
"\"ippfind: Unable to execute \\\"%s\\\": %s\" = \"ippfind：无法执行“%s”：%s\";\n"
"\"ippfind: Unknown variable \\\"{%s}\\\".\" = \"ippfind：未知变量“{%s}”。\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\" = \"ipptool：“-i”和“-n”不能与“--ippserver”，“-P”和“-X”混用。\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"-P\\\" and \\\"-X\\\".\" = \"ipptool：“-i”和“-n”不能与“-P”和“-X”混用。\";\n"
"\"ipptool: Bad URI \\\"%s\\\".\" = \"ipptool：无效的 URI “%s”。\";\n"
"\"ipptool: Invalid seconds for \\\"-i\\\".\" = \"ipptool：“-i”选项后指定的秒数无效。\";\n"
"\"ipptool: May only specify a single URI.\" = \"ipptool：只能指定一个 URI。\";\n"
"\"ipptool: Missing count for \\\"-n\\\".\" = \"ipptool：“-n”选项后缺少数量。\";\n"
"\"ipptool: Missing filename for \\\"--ippserver\\\".\" = \"ipptool：“--ippserver”选项后缺少文件名。\";\n"
"\"ipptool: Missing filename for \\\"-f\\\".\" = \"ipptool：“-f”选项后缺少文件名。\";\n"
"\"ipptool: Missing name=value for \\\"-d\\\".\" = \"ipptool：“-d”选项后缺少 name=value 声明。\";\n"
"\"ipptool: Missing seconds for \\\"-i\\\".\" = \"ipptool：“-i”选项后缺少秒数。\";\n"
...
"\"{}                      URI\" = \"{}                      URI\";\n"
"\"~/.cups/lpoptions file names default destination that does not exist.\" = \"~/.cups/lpoptions 文件所指定的默认目标不存在。\";\n";
