static const char *zh_CN_strings = "\"\" = \"\";\n"
"\"  No Errors\\n\" = \"  No Errors\\n\";\n"
"\"  No Warnings\\n\" = \"  No Warnings\\n\";\n"
"\"! EXPRESSION                   Unary NOT of expression\" = \"! EXPRESSION                   Unary NOT of expression\";\n"
"\"\\\"%s\\\": Bad URI value \\\"%s\\\" - %s (RFC 8011 section 5.1.6).\" = \"“%s”：无效的 URI 值“%s”— %s (RFC 8011 章节 5.1.6)。\";\n"
"\"\\\"%s\\\": Bad URI value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.6).\" = \"“%s”：无效的 URI 值“%s”— 无效长度 %d (RFC 8011 章节 5.1.6)。\";\n"
"\"\\\"%s\\\": Bad attribute name - bad length %d (RFC 8011 section 5.1.4).\" = \"“%s”：无效的属性名称 — 无效长度 %d (RFC 8011 章节 5.1.4)。\";\n"
"\"\\\"%s\\\": Bad attribute name - invalid character (RFC 8011 section 5.1.4).\" = \"“%s”：无效的属性名称 — 无效字符 (RFC 8011 章节 5.1.4)。\";\n"
"\"\\\"%s\\\": Bad boolean value %d (RFC 8011 section 5.1.21).\" = \"“%s”：无效的布里值 %d (RFC 8011 章节 5.1.21)。\";\n"
"\"\\\"%s\\\": Bad charset value \\\"%s\\\" - bad characters (RFC 8011 section 5.1.8).\" = \"“%s”：无效的字符集值“%s”— 无效字符 (RFC 8011 章节 5.1.21)。\";\n"
"\"\\\"%s\\\": Bad charset value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.8).\" = \"“%s”：无效的字符集值“%s”— 无效长度 %d (RFC 8011 章节 5.1.21)。\";\n"
"\"\\\"%s\\\": Bad dateTime UTC hours %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime UTC 小时值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime UTC minutes %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime UTC 分钟值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime UTC sign '%c' (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime UTC 符号值“%c” (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime day %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime 日期值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime deciseconds %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime 十分之一秒值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime hours %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime 小时值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime minutes %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime 分钟值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime month %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime 月份值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad dateTime seconds %u (RFC 8011 section 5.1.15).\" = \"“%s”：无效的 dateTime 秒值 %u (RFC 8011 章节 5.1.15)。\";\n"
"\"\\\"%s\\\": Bad enum value %d - out of range (RFC 8011 section 5.1.5).\" = \"“%s”：无效的枚举值 %d - 超出范围 (RFC 8011 章节 5.1.5)。\";\n"
"\"\\\"%s\\\": Bad keyword value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.4).\" = \"“%s”：无效的关键字值“%s”— 无效长度 %d (RFC 8011 章节 5.1.4)。\";\n"
"\"\\\"%s\\\": Bad keyword value \\\"%s\\\" - invalid character (RFC 8011 section 5.1.4).\" = \"“%s”：无效的关键字值“%s”— 无效字符 (RFC 8011 章节 5.1.4)。\";\n"
"\"\\\"%s\\\": Bad mimeMediaType value \\\"%s\\\" - bad characters (RFC 8011 section 5.1.10).\" = \"“%s”：无效的 mimeMediaType 值“%s”— 无效字符 (RFC 8011 章节 5.1.10)。\";\n"
"\"\\\"%s\\\": Bad mimeMediaType value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.10).\" = \"“%s”：无效的 mimeMediaType 值“%s”— 无效长度 %d (RFC 8011 章节 5.1.10)。\";\n"
"\"\\\"%s\\\": Bad name value \\\"%s\\\" - bad UTF-8 sequence (RFC 8011 section 5.1.3).\" = \"“%s”：无效的名称值“%s”— 无效 UTF-8 序列 (RFC 8011 章节 5.1.3)。\";\n"
"\"\\\"%s\\\": Bad name value \\\"%s\\\" - bad control character (PWG 5100.14 section 8.1).\" = \"“%s”：无效的名称值“%s”— 无效控制字符 (PWG 5100.14 章节 8.1)。\";\n"
"\"\\\"%s\\\": Bad name value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.3).\" = \"“%s”：无效的名称值“%s”— 无效长度 %d (RFC 8011 章节 5.1.3)。\";\n"
"\"\\\"%s\\\": Bad naturalLanguage value \\\"%s\\\" - bad characters (RFC 8011 section 5.1.9).\" = \"“%s”：无效的 naturalLanguage 值“%s”— 无效字符 (RFC 8011 章节 5.1.9)。\";\n"
"\"\\\"%s\\\": Bad naturalLanguage value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.9).\" = \"“%s”：无效的 naturalLanguage 值“%s”— 无效长度 %d (RFC 8011 章节 5.1.9)。\";\n"
"\"\\\"%s\\\": Bad octetString value - bad length %d (RFC 8011 section 5.1.20).\" = \"“%s”：无效的 octetString 值 — 无效长度 %d (RFC 8011 章节 5.1.20)。\";\n"
"\"\\\"%s\\\": Bad rangeOfInteger value %d-%d - lower greater than upper (RFC 8011 section 5.1.14).\" = \"“%s”：无效的 rangeOfInteger 值 %d-%d — 整数下限大于上限 (RFC 8011 章节 5.1.14)。\";\n"
"\"\\\"%s\\\": Bad resolution value %dx%d%s - bad units value (RFC 8011 section 5.1.16).\" = \"“%s”：无效的分辨率值 %dx%d%s — 无效单位值 (RFC 8011 章节 5.1.16)。\";\n"
"\"\\\"%s\\\": Bad resolution value %dx%d%s - cross feed resolution must be positive (RFC 8011 section 5.1.16).\" = \"“%s”：无效的分辨率值 %dx%d%s — 横截分辨率必须为正数 (RFC 8011 章节 5.1.16)。\";\n"
"\"\\\"%s\\\": Bad resolution value %dx%d%s - feed resolution must be positive (RFC 8011 section 5.1.16).\" = \"“%s”：无效的分辨率值 %dx%d%s — 顺向分辨率必须为正数 (RFC 8011 章节 5.1.16)。\";\n"
"\"\\\"%s\\\": Bad text value \\\"%s\\\" - bad UTF-8 sequence (RFC 8011 section 5.1.2).\" = \"“%s”：无效的文本值“%s”— 无效 UTF-8 序列 (RFC 8011 章节 5.1.2)。\";\n"
"\"\\\"%s\\\": Bad text value \\\"%s\\\" - bad control character (PWG 5100.14 section 8.3).\" = \"“%s”：无效的文本值“%s”— 无效控制字符 (PWG 5100.14 章节 8.3)。\";\n"
"\"\\\"%s\\\": Bad text value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.2).\" = \"“%s”：无效的文本值“%s”— 无效长度 %d (RFC 8011 章节 5.1.2)。\";\n"
"\"\\\"%s\\\": Bad uriScheme value \\\"%s\\\" - bad characters (RFC 8011 section 5.1.7).\" = \"“%s”：无效的 uriScheme 值“%s”— 无效字符 (RFC 8011 章节 5.1.7)。\";\n"
"\"\\\"%s\\\": Bad uriScheme value \\\"%s\\\" - bad length %d (RFC 8011 section 5.1.7).\" = \"“%s”：无效的 uriScheme 值“%s”— 无效长度 %d (RFC 8011 章节 5.1.7)。\";\n"
"\"%d x %d mm\" = \"%d x %d 毫米\";\n"
"\"%g x %g \\\"\" = \"%g x %g \\\"\";\n"
"\"%s (%s)\" = \"%s (%s)\";\n"
"\"%s (%s, %s)\" = \"%s (%s, %s)\";\n"
"\"%s (Borderless)\" = \"%s (无边界)\";\n"
"\"%s (Borderless, %s)\" = \"%s (无边界，%s)\";\n"
"\"%s (Borderless, %s, %s)\" = \"%s (无边界，%s，%s)\";\n"
"\"%s: %s\" = \"%s: %s\";\n"
...
"\"/etc/cups/lpoptions file names default destination that does not exist.\" = \"/etc/cups/lpoptions 文件所指定的默认目标不存在。\";\n"
"\"Accepted\" = \"已接受\";\n"
"\"Already Reported\" = \"Already Reported\";\n"
"\"Bad Gateway\" = \"Bad Gateway\";\n"
"\"Bad NULL dests pointer\" = \"无效的 NULL 目标指针\";\n"
"\"Bad Request\" = \"无效请求\";\n"
"\"Bad URI.\" = \"无效的 URI。\";\n"
"\"Bad arguments to function\" = \"函数的参数无效\";\n"
...
"\"Encryption is not supported.\" = \"不支持加密。\";\n"
"\"Environment Variables:\" = \"环境变量：\";\n"
"\"Errors:\\n\" = \"Errors:\\n\";\n"
"\"Expectation Failed\" = \"未满足期望\";\n"
"\"Expressions:\" = \"表达式：\";\n"
...
"\"Hash buffer too small.\" = \"哈希值缓冲区太小。\";\n"
"\"IPP 1setOf attribute with incompatible value tags.\" = \"IPP 1setOf attribute with incompatible value tags.\";\n"
"\"IPP attribute has no name.\" = \"IPP 属性未命名。\";\n"
"\"IPP attribute is not a member of the message.\" = \"IPP 属性不是消息成员。\";\n"
"\"IPP begCollection value not 0 bytes.\" = \"IPP begCollection 值大小不是 0 字节。\";\n"
"\"IPP boolean value not 1 byte.\" = \"IPP 布里值大小不是 1 字节。\";\n"
"\"IPP date value not 11 bytes.\" = \"IPP 日期值大小不是 11 字节。\";\n"
"\"IPP endCollection value not 0 bytes.\" = \"IPP endCollection 值大小不是 0 字节。\";\n"
"\"IPP enum value not 4 bytes.\" = \"IPP enum 值大小不是 4 字节。\";\n"
"\"IPP integer value not 4 bytes.\" = \"IPP 整数值大小不是 4 字节。\";\n"
"\"IPP language length overflows value.\" = \"IPP 语言长度溢出值限制。\";\n"
"\"IPP language length too large.\" = \"IPP 语言长度太长。\";\n"
"\"IPP member attribute outside of collection.\" = \"IPP member attribute outside of collection.\";\n"
"\"IPP member name is not empty.\" = \"IPP 成员名称非空。\";\n"
"\"IPP memberName value is empty.\" = \"IPP memberName 值为空。\";\n"
"\"IPP message nested too deeply.\" = \"IPP message nested too deeply.\";\n"
"\"IPP name larger than 32767 bytes.\" = \"IPP 名称大小超过 32767 字节。\";\n"
"\"IPP nameWithLanguage value less than minimum 4 bytes.\" = \"IPP nameWithLanguage value less than minimum 4 bytes.\";\n"
"\"IPP octetString length too large.\" = \"IPP octetString 长度过长。\";\n"
"\"IPP rangeOfInteger value not 8 bytes.\" = \"IPP rangeOfInteger 值大小不是 8 字节。\";\n"
"\"IPP resolution value not 9 bytes.\" = \"IPP 分辨率值大小不是 9 字节。\";\n"
"\"IPP string length overflows value.\" = \"IPP 字串长度超过溢出值限制。\";\n"
"\"IPP textWithLanguage value less than minimum 4 bytes.\" = \"IPP textWithLanguage value less than minimum 4 bytes.\";\n"
"\"IPP value larger than 32767 bytes.\" = \"IPP 值大小超过 32767 字节。\";\n"
...
"\"Invalid group tag.\" = \"无效的组标签。\";\n"
"\"Invalid media name arguments.\" = \"无效的媒体名称参数。\";\n"
"\"Invalid media size.\" = \"无效的媒体大小。\";\n"
...
"\"LPDEST environment variable names default destination that does not exist.\" = \"LPDEST 环境变量所指定的默认目标不存在。\";\n"
...
"\"Missing media or media-col.\" = \"缺少 media 或 media-col。\";\n"
"\"Missing media-size in media-col.\" = \"media-col 中缺少 media-size。\";\n"
"\"Missing resource in URI\" = \"URI 中缺少资源\";\n"
"\"Missing scheme in URI\" = \"URI 中缺少方案\";\n"
"\"Missing x-dimension in media-size.\" = \"media-size 中缺少 x-dimension。\";\n"
"\"Missing y-dimension in media-size.\" = \"media-size 中缺少 y-dimension。\";\n"
"\"Modifiers:\" = \"修饰符：\";\n"
...
"\"New credentials are not valid for name.\" = \"新凭据不可用于名称。\";\n"
"\"New credentials are older than stored credentials.\" = \"新凭据老于已存储的凭据。\";\n"
"\"No Content\" = \"无内容\";\n"
"\"No JWKS URI in authorization server metadata.\" = \"No JWKS URI in authorization server metadata.\";\n"
"\"No active connection\" = \"无活动连接\";\n"
"\"No active connection.\" = \"无活动连接。\";\n"
"\"No default destination.\" = \"无默认目标。\";\n"
"\"No request URI.\" = \"无请求 URI。\";\n"
"\"No request protocol version.\" = \"无请求协议版本。\";\n"
"\"No request sent.\" = \"未发送请求。\";\n"
"\"No stored credentials, not valid for name.\" = \"无已存储的凭据，不可用于名称。\";\n"
...
"\"PRINTER environment variable names default destination that does not exist.\" = \"PRINTER 环境变量所指定的默认目标不存在。\";\n"
"\"Pages:\" = \"Pages:\";\n"
"\"Partial Content\" = \"Partial Content\";\n"
"\"Password for %s on %s? \" = \"请输入 %2$s 上 %1$s 的密码 \";\n"
...
"\"See Other\" = \"查看其他\";\n"
"\"Self-signed credentials are blocked.\" = \"禁止使用自签发的凭据。\";\n"
"\"Server Error\" = \"Server Error\";\n"
"\"Server credentials not set.\" = \"未设置服务器凭据。\";\n"
"\"Service Unavailable\" = \"服务不可用\";\n"
"\"Sheet Backs:\" = \"Sheet Backs:\";\n"
"\"Sub-Commands:\" = \"Sub-Commands:\";\n"
"\"Substitutions:\" = \"替代：\";\n"
"\"Switching Protocols\" = \"正在切换协议\";\n"
...
"\"The printer or class does not exist.\" = \"打印机或类不存在。\";\n"
"\"Title:\" = \"Title:\";\n"
"\"Too Early\" = \"Too Early\";\n"
"\"Too Many Requests\" = \"Too Many Requests\";\n"
"\"Trust on first use is disabled.\" = \"初次使用信任已禁用。\";\n"
"\"Types:\" = \"Types:\";\n"
"\"URI Too Long\" = \"URI 过长\";\n"
"\"URI too large\" = \"URI 过大\";\n"
"\"Unable to add extension to X.509 certificate.\" = \"Unable to add extension to X.509 certificate.\";\n"
"\"Unable to compile mimeMediaType regular expression: %s.\" = \"无法编译 mimeMediaType 正则表达式：%s。\";\n"
"\"Unable to compile naturalLanguage regular expression: %s.\" = \"无法编译 naturalLanguage 正则表达式：%s。\";\n"
"\"Unable to configure private key context.\" = \"Unable to configure private key context.\";\n"
"\"Unable to connect to host.\" = \"无法连接主机。\";\n"
...
"\"Unable to create printer-uri\" = \"无法创建 printer-uri。\";\n"
...
"\"Unable to create server credentials.\" = \"无法创建服务器凭据。\";\n"
...
"\"Unable to resolve printer-uri.\" = \"无法解析 printer-uri。\";\n"
...
"\"Unknown\" = \"未知\";\n"
"\"Unknown hash algorithm.\" = \"未知哈希值算法。\";\n"
"\"Unknown media size name.\" = \"未知介质尺寸名。\";\n"
"\"Unknown request method.\" = \"未知请求方式。\";\n"
"\"Unknown request version.\" = \"未知请求版本。\";\n"
"\"Unknown scheme in URI\" = \"URI 中含有未知方案\";\n"
"\"Unknown service name.\" = \"未知服务名称。\";\n"
"\"Unprocessable Content\" = \"Unprocessable Content\";\n"
"\"Unsupported Media Type\" = \"Unsupported Media Type\";\n"
"\"Unsupported media value.\" = \"不支持的介质值。\";\n"
...
"\"ipptool: May only specify a single URI.\" = \"ipptool：只能指定一个 URI。\";\n"
"\"ipptool: Missing filename for \\\"-f\\\".\" = \"ipptool：“-f”选项后缺少文件名。\";\n"
"\"ipptool: URI required before test file.\" = \"ipptool：测试文件前需要 URI。\";\n"
