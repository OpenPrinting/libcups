...
"\"Usage: ipptool [options] URI filename [ ... filenameN ]\" = \"Sintaxi: ipptool [opcions] URI nomfitxer[ ... nomfitxerN]\";\n"
"\"Use Proxy\" = \"Use Proxy\";\n"
...
"\"ipptool: Invalid seconds for \\\"-i\\\".\" = \"ipptool: els segons de «-i» no són correctes.\";\n"
"\"ipptool: May only specify a single URI.\" = \"ipptool: heu d'especificar només un URI.\";\n"
"\"ipptool: Missing count for \\\"-n\\\".\" = \"ipptool: falta el comptador de «-n».\";\n"
...
"\"ipptool: Missing name=value for \\\"-d\\\".\" = \"ipptool: falta nom=valor a «-d».\";\n"
"\"ipptool: Missing seconds for \\\"-i\\\".\" = \"ipptool: falten els segons a «-i».\";\n"
