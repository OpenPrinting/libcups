...
"\"Bad NULL dests pointer\" = \"El punter de dests NULL és incorrecte\";\n"
"\"Bad Request\" = \"La petició és incorrecta\";\n"
"\"Bad URI.\" = \"Bad URI.\";\n"
...
"\"IPP attribute has no name.\" = \"L'atribut del IPP no té nom.\";\n"
"\"IPP attribute is not a member of the message.\" = \"L'atribut del IPP no és membre del missatge.\";\n"
"\"IPP begCollection value not 0 bytes.\" = \"El valor de begColletion del IPP no té 0 bytes.\";\n"
"\"IPP boolean value not 1 byte.\" = \"El valor booleà del IPP no té 1 byte.\";\n"
"\"IPP date value not 11 bytes.\" = \"El valor de date del IPP no té 11 bytes.\";\n"
"\"IPP endCollection value not 0 bytes.\" = \"El valor de endColletion del IPP no té 0 bytes.\";\n"
"\"IPP enum value not 4 bytes.\" = \"El valor de enum del IPP no té 4 bytes.\";\n"
"\"IPP integer value not 4 bytes.\" = \"El valor enter de IPP no té 4 bytes.\";\n"
"\"IPP language length overflows value.\" = \"El valor de la longitud del llenguatge del IPP desborda.\";\n"
...
"\"IPP member name is not empty.\" = \"El nom del membre del IPP no està buit.\";\n"
"\"IPP memberName value is empty.\" = \"El valor de memberName de l'IPP està buit.\";\n"
"\"IPP message nested too deeply.\" = \"IPP message nested too deeply.\";\n"
"\"IPP name larger than 32767 bytes.\" = \"EL nom del IPP és més llarg de 32767 bytes.\";\n"
...
"\"IPP rangeOfInteger value not 8 bytes.\" = \"El valor de rangeOfInteger del IPP no té 8 bytes.\";\n"
"\"IPP resolution value not 9 bytes.\" = \"El valor de resolution del IPP no té 9 bytes.\";\n"
"\"IPP string length overflows value.\" = \"El valor de la longitud de la cadena del IPP desborda.\";\n"
"\"IPP textWithLanguage value less than minimum 4 bytes.\" = \"IPP textWithLanguage value less than minimum 4 bytes.\";\n"
"\"IPP value larger than 32767 bytes.\" = \"El valor del IPP és més llarg de 32767 bytes.\";\n"
...
"\"Invalid media size.\" = \"Mida del suport no vàlida.\";\n"
...
"\"Missing media-size in media-col.\" = \"Falta el media-size al media-col.\";\n"
"\"Missing resource in URI\" = \"Missing resource in URI\";\n"
"\"Missing scheme in URI\" = \"Missing scheme in URI\";\n"
"\"Missing x-dimension in media-size.\" = \"Falta la mida x a la mida del suport.\";\n"
"\"Missing y-dimension in media-size.\" = \"Falta la mida y a la mida del suport.\";\n"
"\"Modifiers:\" = \"Modifiers:\";\n"
"\"Moved Permanently\" = \"S'ha mogut de manera permanent\";\n"
...
"\"Not Modified\" = \"No està modificat\";\n"
"\"OK\" = \"D'acord\";\n"
...
"\"Types:\" = \"Types:\";\n"
"\"URI Too Long\" = \"L'URI és massa llarg\";\n"
...
"\"Unable to connect to host.\" = \"No es pot connectar a l'amfitrió.\";\n"
...
"\"Unable to create printer-uri\" = \"No es pot crear el printer-uri\";\n"
...
"\"Unknown media size name.\" = \"El nom de la mida del suport no és conegut.\";\n"
...
"\"Unknown service name.\" = \"El nom del servei és desconegut.\";\n"
...
"\"ipptool: May only specify a single URI.\" = \"ipptool: heu d'especificar només un URI.\";\n"
"\"ipptool: Missing filename for \\\"-f\\\".\" = \"ipptool: falta el nom del fitxer a «-f».\";\n"
"\"ipptool: URI required before test file.\" = \"ipptool: falta l'URI abans del fitxer de prova.\";\n"
