...
"\"( expressions )         Group expressions\" = \"( udtryk )              Gruppér udtryk\";\n"
"\"--domain regex          Match domain to regular expression\" = \"--domain reg-udtryk     Match domæne til regulært udtryk\";\n"
"\"--exec utility [argument ...] ;\\n\" = \"--exec utility [argument ...] ;\\n\";\n"
"\"--false                 Always false\" = \"--false                 Altid falsk\";\n"
"\"--help                  Show program help\" = \"--help                  Vis hjælp til program\";\n"
"\"--host regex            Match hostname to regular expression\" = \"--host reg-udtryk       Match værtsnavn til regulært udtryk\";\n"
"\"--ippserver filename    Produce ippserver attribute file\" = \"--ippserver filnavn     Generer ippserver-attributfil\";\n"
"\"--literal-name name     Match service name to literal name value\" = \"--literal-name name     Match service name to literal name value\";\n"
"\"--local                 True if service is local\" = \"--local                 Sand hvis tjeneste er lokal\";\n"
"\"--ls                    List attributes\" = \"--ls                    Vis attributter\";\n"
"\"--name regex            Match service name to regular expression\" = \"--name reg-udtryk       Match tjenestenavn til regulært udtryk\";\n"
"\"--no-web-forms          Disable web forms for media and supplies\" = \"--no-web-forms          Deaktivér webformularer for medier og forsyninger\";\n"
"\"--not expression        Unary NOT of expression\" = \"--not udtryk            Unær IKKE af udtryk\";\n"
"\"--pam-service service   Use the named PAM service\" = \"--pam-service service   Use the named PAM service\";\n"
"\"--path regex            Match resource path to regular expression\" = \"--path reg-udtryk       Match ressourcesti til regulært udtryk\";\n"
"\"--port number[-number]  Match port to number or range\" = \"--port nummer[-nummer]  Match port til nummer eller område\";\n"
"\"--print                 Print URI if true\" = \"--print                 Udskriv URI, hvis sand\";\n"
"\"--print-name            Print service name if true\" = \"--print-name            Udskriv tjenestenavn, hvis sand\";\n"
"\"--quiet                 Quietly report match via exit code\" = \"--quiet                 Stille rapportering af match via afslutningskode\";\n"
"\"--remote                True if service is remote\" = \"--remote                Sand hvis fjerntjeneste\";\n"
"\"--stop-after-include-error\\n\" = \"--stop-after-include-error\\n\";\n"
"\"--true                  Always true\" = \"--true                  Altid sand\";\n"
"\"--txt key               True if the TXT record contains the key\" = \"--txt nøgle             Sand hvis TXT-registreringen indeholder nøglen\";\n"
"\"--txt-* regex           Match TXT record key to regular expression\" = \"--txt-* reg-udtryk      Match TXT-registreringsnøgle til regulært udtryk\";\n"
"\"--uri regex             Match URI to regular expression\" = \"--uri reg-udtryk        Match URI til regulært udtryk\";\n"
"\"--version               Show program version\" = \"--version               Vis programversion\";\n"
"\"--version               Show version\" = \"--version               Vis version\";\n"
"\"-2                      Set 2-sided printing support (default=1-sided)\" = \"-2                      Indstil understøttelse af dobbeltsidet udskrivning (standard=enkeltsidet)\";\n"
"\"-4                      Connect using IPv4\" = \"-4                      Opret forbindelse med IPv4\";\n"
"\"-6                      Connect using IPv6\" = \"-6                      Opret forbindelse med IPv6\";\n"
"\"-A                      Enable authentication\" = \"-A                      Enable authentication\";\n"
"\"-C                      Send requests using chunking (default)\" = \"-C                      Send anmodninger med \\\"chunking\\\" (standard)\";\n"
"\"-D device-uri           Set the device URI for the printer\" = \"-D enheds-uri           Indstil enheds-URI'en til printeren\";\n"
"\"-E                      Test with encryption using HTTP Upgrade to TLS\" = \"-E                      Test med kryptering med HTTP Upgrade til TLS\";\n"
"\"-F output-type/subtype  Set the output format for the printer\" = \"-F outputtype/undertype Indstil outputformatet til printeren\";\n"
"\"-I                      Ignore errors\" = \"-I                      Ignorer fejl\";\n"
"\"-K keypath              Set location of server X.509 certificates and keys.\" = \"-K nøglesti             Indstil placeringen af serverens X.509-certifikater og -nøgler.\";\n"
"\"-L                      Send requests using content-length\" = \"-L                      Send anmodninger med content-length\";\n"
"\"-M manufacturer         Set manufacturer name (default=Test)\" = \"-M producent            Indstil producentnavn (standard=Test)\";\n"
"\"-N name                 Match service name to literal name value\" = \"-N name                 Match service name to literal name value\";\n"
"\"-P filename.plist       Produce XML plist to a file and test report to standard output\" = \"-P filnavn.plist        Generer XML-plist til en fil og test rapportering til standardoutput\";\n"
"\"-P number[-number]      Match port to number or range\" = \"-P nummer[-nummer]      Match port til nummer eller område\";\n"
"\"-R                      Repeat tests on server-error-busy\" = \"-R                      Repeat tests on server-error-busy\";\n"
"\"-S                      Test with encryption using HTTPS\" = \"-S                      Test med kryptering med HTTPS\";\n"
"\"-S filename.strings     Set strings file\" = \"-S filename.strings     Set strings file\";\n"
"\"-T seconds              Set the browse timeout in seconds\" = \"-T sekunder             Indstil timeout for gennemse i sekunder\";\n"
"\"-T seconds              Set the receive/send timeout in seconds\" = \"-T sekunder             Indstil timeouten for modtag/send i sekunder\";\n"
"\"-V version              Set default IPP version\" = \"-V version              Indstil standard-IPP-version\";\n"
"\"-X                      Produce XML plist instead of plain text\" = \"-X                      Generer XML-plist i stedet for ren tekst\";\n"
"\"-a filename.conf        Load printer attributes from conf file\" = \"-a filnavn.conf         Indlæs printerattributter fra conf-fil\";\n"
"\"-c                      Produce CSV output\" = \"-c                      Generer CSV-output\";\n"
"\"-c command              Set print command\" = \"-c kommando             Indstil udskrivningskommando\";\n"
"\"-d name=value           Set named variable to value\" = \"-d navn=værdi           Indstil navngivet variabel til værdi\";\n"
"\"-d regex                Match domain to regular expression\" = \"-d reg-udtryk           Match domæne til regulært udtryk\";\n"
"\"-d spool-directory      Set spool directory\" = \"-d spool-mappe          Indstil \\\"spool\\\"-mappe\";\n"
"\"-f filename             Set default request filename\" = \"-f filnavn              Indstil standardanmodningsfilnavn\";\n"
"\"-f type/subtype[,...]   Set supported file types\" = \"-f type/undertype[,...] Indstil understøttede filtyper\";\n"
"\"-h                      Validate HTTP response headers\" = \"-h                      Valider headere i HTTP-svar\";\n"
"\"-h regex                Match hostname to regular expression\" = \"-h reg-udtryk           Match værtsnavn til regulært udtryk\";\n"
"\"-i iconfile.png[,...]   Set icon file(s)\" = \"-i iconfile.png[,...]   Set icon file(s)\";\n"
"\"-i seconds              Repeat the last file with the given time interval\" = \"-i sekunder             Gentag den sidste fil med det angive tidsinterval\";\n"
"\"-k                      Keep job spool files\" = \"-k                      Bevar jobbets \\\"spool\\\"-filer\";\n"
"\"-l                      List attributes\" = \"-l                      Vis attributter\";\n"
"\"-l                      Produce plain text output\" = \"-l                      Generer output i ren tekst\";\n"
"\"-l location             Set location of printer\" = \"-l placering            Indstil placeringen af printeren\";\n"
"\"-m model                Set model name (default=Printer)\" = \"-m model                Indstil modelnavn (standard=Printer)\";\n"
"\"-n count                Repeat the last file the given number of times\" = \"-n antal                Gentag den sidste fil det angivne antal gange\";\n"
"\"-n hostname             Set hostname for printer\" = \"-n værtsnavn            Indstil værtsnavn til printeren\";\n"
"\"-n regex                Match service name to regular expression\" = \"-n reg-udtryk           Match tjenestenavn til regulært udtryk\";\n"
"\"-p                      Print URI if true\" = \"-p                      Udskriv URI, hvis sand\";\n"
"\"-p port                 Set port number for printer\" = \"-p port                 Indstil portnummer til printer\";\n"
"\"-q                      Quietly report match via exit code\" = \"-q                      Stille rapportering af match via afslutningskode\";\n"
"\"-q                      Run silently\" = \"-q                      Kør stille\";\n"
"\"-r                      True if service is remote\" = \"-r                      Sand hvis fjerntjeneste\";\n"
"\"-r subtype,[subtype]    Set DNS-SD service subtype\" = \"-r undertype,[undertype] Indstil DNS-SD-tjenestens undertype\";\n"
"\"-s                      Print service name if true\" = \"-s                      Udskriv tjenestenavn, hvis sand\";\n"
"\"-s speed[,color-speed]  Set speed in pages per minute\" = \"-s hastighed[,farve-hastighed] Indstil hastighed, i sider pr. minut\";\n"
"\"-t                      Produce a test report\" = \"-t                      Generer en testrapport\";\n"
"\"-t key                  True if the TXT record contains the key\" = \"-t nøgle                Sand hvis TXT-registreringen indeholder nøglen\";\n"
"\"-u regex                Match URI to regular expression\" = \"-u reg-udtryk           Match URI til regulært udtryk\";\n"
"\"-v                      Be verbose\" = \"-v                      Vær uddybende\";\n"
"\"-x utility [argument ...] ;\\n\" = \"-x utility [argument ...] ;\\n\";\n"
...
"\"Usage: ippeveprinter [options] \\\"name\\\"\" = \"Anvendelse: ippeveprinter [tilvalg] \\\"navn\\\"\";\n"
"\"Usage: ippfind [options] regtype[,subtype]\" = \"Usage: ippfind [options] regtype[,subtype]\";\n"
"\"Usage: ipptool [options] URI filename [ ... filenameN ]\" = \"Anvendelse: ipptool [tilvalg] URI filnavn [ ... filnavnN ]\";\n"
"\"Use Proxy\" = \"Use Proxy\";\n"
