...
"\"%s: Missing filename after '-L'.\" = \"%s: Missing filename after '-L'.\";\n"
...
"\"%s: Missing user agent after '--user-agent'.\" = \"%s: Missing user agent after '--user-agent'.\";\n"
...
"\"-L LOGFILE                     Set log file (start with '+' to append)\" = \"-L LOGFILE                     Set log file (start with '+' to append)\";\n"
