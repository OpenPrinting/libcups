...
"\"%s: Bad version %s for \\\"-V\\\".\" = \"%s: Versão inválida %s para \\\"-V\\\".\";\n"
"\"%s: Missing filename for \\\"-P\\\".\" = \"%s: Faltando nome de arquivo para \\\"-P\\\".\";\n"
"\"%s: Missing timeout for \\\"-T\\\".\" = \"%s: Faltando tempo de espera para \\\"-T\\\".\";\n"
"\"%s: Missing version for \\\"-V\\\".\" = \"%s: Faltando versão para \\\"-V\\\".\";\n"
"\"%s: Unable to open \\\"%s\\\": %s\" = \"%s: Não foi possível abrir \\\"%s\\\": %s\";\n"
"\"%s: Unknown option \\\"%s\\\".\" = \"%s: Opção desconhecida \\\"%s\\\".\";\n"
"\"%s: Unknown option \\\"-%c\\\".\" = \"%s: Opção desconhecida \\\"-%c\\\".\";\n"
...
"\"Usage: ipptool [options] URI filename [ ... filenameN ]\" = \"Uso: ipptool [opções] URI arquivo [ ... arquivoN ]\";\n"
"\"Use Proxy\" = \"Use Proxy\";\n"
...
"\"ippfind: Bad regular expression: %s\" = \"ippfind: Expressão regular inválida: %s\";\n"
"\"ippfind: Cannot use --and after --or.\" = \"ippfind: Não é possível usar --and após --or.\";\n"
"\"ippfind: Expected key name after %s.\" = \"ippfind: Esperava nome da chave após %s.\";\n"
"\"ippfind: Expected port range after %s.\" = \"ippfind: Esperava faixa de portas após %s.\";\n"
"\"ippfind: Expected program after %s.\" = \"ippfind: Esperava o programa após %s.\";\n"
"\"ippfind: Expected semi-colon after %s.\" = \"ippfind: Esperava ponto-e-vírgula após %s.\";\n"
"\"ippfind: Missing close brace in substitution.\" = \"ippfind: Faltando chave de fechamento na substituição.\";\n"
"\"ippfind: Missing close parenthesis.\" = \"ippfind: Faltando parênteses de fechamento.\";\n"
"\"ippfind: Missing expression before \\\"--and\\\".\" = \"ippfind: Faltando expressão antes de \\\"--and\\\".\";\n"
"\"ippfind: Missing expression before \\\"--or\\\".\" = \"ippfind: Faltando expressão antes de \\\"--or\\\".\";\n"
"\"ippfind: Missing key name after %s.\" = \"ippfind: Faltando nome da chave após %s.\";\n"
"\"ippfind: Missing name after %s.\" = \"ippfind: Missing name after %s.\";\n"
"\"ippfind: Missing open parenthesis.\" = \"ippfind: Faltando parênteses de abertura.\";\n"
"\"ippfind: Missing program after %s.\" = \"ippfind: Faltando programa após %s.\";\n"
"\"ippfind: Missing regular expression after \" = \"ippfind: Missing regular expression after \";\n"
"\"ippfind: Missing regular expression after %s.\" = \"ippfind: Faltando expressão regular após %s.\";\n"
"\"ippfind: Missing semi-colon after %s.\" = \"ippfind: Faltando dois-pontos após %s.\";\n"
"\"ippfind: Out of memory.\" = \"ippfind: Memória insuficiente.\";\n"
"\"ippfind: Too many parenthesis.\" = \"ippfind: Número excessivo de parênteses.\";\n"
"\"ippfind: Unable to execute \\\"%s\\\": %s\" = \"ippfind: Não foi possível executar \\\"%s\\\": %s\";\n"
"\"ippfind: Unknown variable \\\"{%s}\\\".\" = \"ippfind: Argumento desconhecido \\\"{%s}\\\".\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\" = \"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"-P\\\" and \\\"-X\\\".\" = \"ipptool: \\\"-i\\\" e \\\"-n\\\" são incompatíveis com \\\"-P\\\" e \\\"-X\\\".\";\n"
"\"ipptool: Bad URI \\\"%s\\\".\" = \"ipptool: Bad URI \\\"%s\\\".\";\n"
"\"ipptool: Invalid seconds for \\\"-i\\\".\" = \"ipptool: Segundos inválidos para \\\"-i\\\".\";\n"
"\"ipptool: May only specify a single URI.\" = \"ipptool: Só é possível especificar uma única URI.\";\n"
"\"ipptool: Missing count for \\\"-n\\\".\" = \"ipptool: Contagem faltando para \\\"-n\\\".\";\n"
...
"\"ipptool: Missing name=value for \\\"-d\\\".\" = \"ipptool: Faltando nome=valor para\\\"-d\\\".\";\n"
"\"ipptool: Missing seconds for \\\"-i\\\".\" = \"ipptool: Faltando segundos para \\\"-i\\\".\";\n"
