...
"\"%s: Bad version %s for \\\"-V\\\".\" = \"%s: Versión %s incorrecta para \\\"-V\\\".\";\n"
"\"%s: Missing filename for \\\"-P\\\".\" = \"%s: Falta el nombre del archivo para \\\"-P\\\".\";\n"
"\"%s: Missing timeout for \\\"-T\\\".\" = \"%s: Falta el tiempo de espera para \\\"-T\\\".\";\n"
"\"%s: Missing version for \\\"-V\\\".\" = \"%s: Falta la versión para \\\"-V\\\".\";\n"
"\"%s: Unable to open \\\"%s\\\": %s\" = \"%s: No se pudo abrir \\\"%s\\\": %s\";\n"
"\"%s: Unknown option \\\"%s\\\".\" = \"%s: Opción \\\"%s\\\" desconocida.\";\n"
"\"%s: Unknown option \\\"-%c\\\".\" = \"%s: Opción \\\"-%c\\\" desconocida.\";\n"
...
"\"Usage: ipptool [options] URI filename [ ... filenameN ]\" = \"Uso: ipptool [opciones] URI nombre_archivo [ ... nombre_archivoN ]\";\n"
"\"Use Proxy\" = \"Use Proxy\";\n"
...
"\"ippfind: Bad regular expression: %s\" = \"ippfind: Expresión regular incorrecta: %s\";\n"
"\"ippfind: Cannot use --and after --or.\" = \"ippfind: No se puede usar --and tras --or.\";\n"
"\"ippfind: Expected key name after %s.\" = \"ippfind: Se esperaba un nombre de clave tras %s.\";\n"
"\"ippfind: Expected port range after %s.\" = \"ippfind: Se esperaba un intervalo de puertos tras %s.\";\n"
"\"ippfind: Expected program after %s.\" = \"ippfind: Se esperaba un programa tras %s.\";\n"
"\"ippfind: Expected semi-colon after %s.\" = \"ippfind: Se esperaba un punto y coma tras %s.\";\n"
"\"ippfind: Missing close brace in substitution.\" = \"ippfind: Falta la llave de cierre en la substitución.\";\n"
"\"ippfind: Missing close parenthesis.\" = \"ippfind: Falta el paréntesis de cierre.\";\n"
"\"ippfind: Missing expression before \\\"--and\\\".\" = \"ippfind: Falta una expresión antes de \\\"--and\\\".\";\n"
"\"ippfind: Missing expression before \\\"--or\\\".\" = \"ippfind: Falta una expresión antes de \\\"--or\\\".\";\n"
"\"ippfind: Missing key name after %s.\" = \"ippfind: Falta un nombre de clave tras %s.\";\n"
"\"ippfind: Missing name after %s.\" = \"ippfind: Missing name after %s.\";\n"
"\"ippfind: Missing open parenthesis.\" = \"ippfind: Falta el paréntesis de apertura.\";\n"
"\"ippfind: Missing program after %s.\" = \"ippfind: Falta un programa tras %s.\";\n"
"\"ippfind: Missing regular expression after \" = \"ippfind: Missing regular expression after \";\n"
"\"ippfind: Missing regular expression after %s.\" = \"ippfind: Falta una expresión regular tras %s.\";\n"
"\"ippfind: Missing semi-colon after %s.\" = \"ippfind: Falta un punto y coma tras %s.\";\n"
"\"ippfind: Out of memory.\" = \"ippfind: Sin memoria.\";\n"
"\"ippfind: Too many parenthesis.\" = \"ippfind: Demasiados paréntesis.\";\n"
"\"ippfind: Unable to execute \\\"%s\\\": %s\" = \"ippfind: No se ha podido ejecutar \\\"%s\\\": %s\";\n"
"\"ippfind: Unknown variable \\\"{%s}\\\".\" = \"ippfind: Variable desconocida \\\"{%s}\\\".\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\" = \"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"--ippserver\\\", \\\"-P\\\", and \\\"-X\\\".\";\n"
"\"ipptool: \\\"-i\\\" and \\\"-n\\\" are incompatible with \\\"-P\\\" and \\\"-X\\\".\" = \"ipptool: \\\"-i\\\" y \\\"-n\\\" no son compatibles con \\\"-P\\\" y \\\"-X\\\".\";\n"
"\"ipptool: Bad URI \\\"%s\\\".\" = \"ipptool: Bad URI \\\"%s\\\".\";\n"
"\"ipptool: Invalid seconds for \\\"-i\\\".\" = \"ipptool: Número de segundos no válido para \\\"-i\\\".\";\n"
"\"ipptool: May only specify a single URI.\" = \"ipptool: Sólo se puede especificar un URI.\";\n"
"\"ipptool: Missing count for \\\"-n\\\".\" = \"ipptool: Falta el contador para \\\"-n\\\".\";\n"
...
"\"ipptool: Missing name=value for \\\"-d\\\".\" = \"ipptool: Falta un nombre=valor para \\\"-d\\\".\";\n"
"\"ipptool: Missing seconds for \\\"-i\\\".\" = \"ipptool: Falta el número de segundos para \\\"-i\\\".\";\n"
