...
// functions:
//
// - `_CUPS_DEPRECATED("message")`: Function is deprecated and has a
//   replacement.
...
#    define _CUPS_DEPRECATED(m) _CUPS_PUBLIC
...
#    define _CUPS_DEPRECATED(m) __attribute__ ((unavailable(m))) _CUPS_PUBLIC

#  elif defined(__APPLE__)
     // Just mark things as deprecated...
#    define _CUPS_DEPRECATED(m) __attribute__ ((deprecated(m))) _CUPS_PUBLIC
...
#      define _CUPS_DEPRECATED(m) __attribute__ ((deprecated(m))) _CUPS_PUBLIC
#    else
#      define _CUPS_DEPRECATED(m) __attribute__ ((deprecated)) _CUPS_PUBLIC
