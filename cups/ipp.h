...
typedef enum ipp_op_e			/**** IPP operations ****/
{
  ...
  IPP_OP_CUPS_GET_DOCUMENT = 0x4027,	/* CUPS-Get-Document: Get a document file */
...
extern ipp_file_t	*ippFileOpen(const char *filename, const char *mode, ipp_file_t *parent, ipp_fattr_cb_t attr_cb, ipp_ferror_cb_t error_cb, void *cb_data) _CUPS_PUBLIC;
extern bool		ippFileRead(ipp_file_t *file, ipp_ftoken_cb_t token_cb) _CUPS_PUBLIC;
extern bool		ippFileReadToken(ipp_file_t *file, char *buffer, size_t bufsize) _CUPS_PUBLIC;
extern void		ippFileSetVar(ipp_file_t *file, const char *name, const char *value) _CUPS_PUBLIC;
extern void		ippFileSetVarf(ipp_file_t *file, const char *name, const char *value, ...) _CUPS_FORMAT(3,4) _CUPS_PUBLIC;
extern bool		ippFileWriteAttributes(ipp_file_t *file, ipp_t *ipp) _CUPS_PUBLIC;
